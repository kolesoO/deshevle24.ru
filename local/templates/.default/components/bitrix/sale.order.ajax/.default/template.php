...
<NOSCRIPT><div style="color:red"><?=Loc::getMessage('SOA_NO_JS')?></div></NOSCRIPT>
        ...
        <div id="bx-soa-order-form-content">
            ...
            <?if (!empty($arResult["ERROR"])) :?>
                <div class="basket-steps col-lg-24">
                    <div class="title-2 light">Ошибки формирования заказа</div>
                    <?foreach ($arResult["ERROR"] as $err) :?>
                        <div><?=$err?></div>
                    <?endforeach?>
                </div>
            <?endif?>
            <div class="basket-steps col-lg-24" flex-align="stretch" flex-wrap="wrap">
                <div class="basket-steps-item col-lg-12 js-basket-step">
