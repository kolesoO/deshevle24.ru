...
<div class="basket-info" flex-align="start" flex-text_align="space-between">
    ...
    <div class="basket-txt basket-txt-header">
...
<?if (empty($arResult['ERROR_MESSAGE']))
{
    ...
    <div id="basket-root" style="opacity: 0;">
        ...
        <div id="basket-items-list-container">
            <div id="basket-items-list-overlay" class="basket-items-list-overlay" style="display: none;"></div>
            <div id="basket-item-list">
                <div id="basket-item-list-empty-result" class="basket-search-not-found" style="display: none;">
                ...
                <div id="basket-item-table" class="basket_list col-lg-24"></div>
            </div>
        </div>
        <div class="basket-txt" data-entity="basket-total-block"></div>
    </div>
	<?
